1.1.Crear un rol nuevo llamado DEVELOPTuNombre que actúe de administrador sobre todo el motor de la base de datos.

/*CREACION ROLE*/
CREATE ROLE IF NOT EXISTS 'DEVELOPFredy';

/*ASIGNACION PRIVILEGIOS*/
GRANT ALL ON *.* TO 'DEVELOPFredy' WITH GRANT OPTION;

/*COMPROBACION PRIVILEGIOS*/
SHOW GRANTS FOR 'DEVELOPFredy';
...
/*CREACION USUARIO*/
CREATE USER IF NOT EXISTS 'THEPFredy'
IDENTIFIED BY '1234'
DEFAULT ROLE DEVELOPFredy; 

/*VERIFICACION CREACION USUARIO*/
SELECT USER FROM mysql.user;

/*VERIFIFICACION PERMISOS*/
SHOW GRANTS FOR 'THEPFredy';
...
SHOW GRANTS FOR DEVELOPFredy; #Privilegios por nombre usuario
